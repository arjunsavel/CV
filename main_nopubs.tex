...
\small
  \begin{list}{}{\cvlist}
\item[{\color{numcolor}\scriptsize18}] \textbf{Arjun Savel}, et al., 2025. ``Leaving Flatland: Toward inferring the 3D structure of exoplanet atmospheres''. FLASH Talk, UCSC, Santa Cruz, CA (upcoming)
