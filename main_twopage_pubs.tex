...
\shortershorterSection{\underline{Selected Contributed Talks (10 total)}}
...
the uncertainty budget of high-resolution spectroscopy of exoplanet atmospheres." Flatiron CCA Pre-doctoral Symposium, New York, NY.
  ...
  \item[{\color{numcolor}\scriptsize2}] \textbf{Arjun Savel}, 2022. ``Modeling Lorentz drag in an ultra-hot Jupiter over a range of atmospheric parameters'', Burgers Program Research Symposium on Environmental and Applied Fluid Dynamics, The George Washington University.
...
\small
  ...
  \textit{Modeling limb asymmetries of cloudy hot Jupiter atmospheres. Paper in prep.}
...
\shorterSection{Skills \& Assets}
  ...
  \small
    \item{
     \textbf{Programming / Markup Languages}{: Python, ADQL/SQL, C, HTML, JavaScript, \LaTeX}
    }
    \vspace{-5pt}
    \item{
