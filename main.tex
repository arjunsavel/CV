...
\small
  \begin{list}{}{\cvlist}
   ...
   \item[{\color{numcolor}\scriptsize17}] \textbf{Arjun Savel}, et al., 2025. ``Leaving Flatland: Toward inferring the 3D structure of exoplanet atmospheres''. FLASH Talk, UCSC, Santa Cruz, CA (upcoming)

   \item[{\color{numcolor}\scriptsize16}] \textbf{Arjun Savel}, et al., 2025. ``Leaving Flatland: Toward inferring the 3D structure of exoplanet atmospheres''. KIPAC Tea Talk, Stanford, Los Angeles, CA (upcoming)
