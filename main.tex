...
\small
  \begin{list}{}{\cvlist}
    \item[{\color{numcolor}\scriptsize12}] \textbf{Arjun Savel}, 2024 (upcoming). ``1D on 3D: Simulating the Impact of 3D Atmospheric Structure on 1D High-Resolution Inferences of Transmission Spectra''. UMB's 46th Annual Graduate Research Conference, Baltimore (2024, upcoming)

    \item[{\color{numcolor}\scriptsize11}] \textbf{Arjun Savel}, 2024 (upcoming). Two HoRSEs, Berlin.

  \item[{\color{numcolor}\scriptsize10}] \textbf{Arjun Savel}, 2024 (upcoming). exoVAST seminar series.
