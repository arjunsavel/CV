...
\small
  ...
  \item[{\color{numcolor}\scriptsize13}] \textbf{Arjun Savel}, 2024 (upcoming). ``1D on 3D: Simulating the Impact of 3D Atmospheric Structure on 1D High-Resolution Inferences of Transmission Spectra''. UMB's 46th Annual Graduate Research Conference, Baltimore (2024, upcoming)
    ...
    \item[{\color{numcolor}\scriptsize12}] \textbf{Arjun Savel}, 2024. ``1D on 3D: Simulating the Impact of 3D Atmospheric Structure on 1D High-Resolution Inferences of Transmission Spectra''. UMD's 46th Annual Graduate Research Conference, University of Maryland, College Park (2024, upcoming)
