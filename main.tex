...
\def\renderunref{%
  \iffileempty{src/supp_tex/pubs_unref.tex}{}{
...
\small
  \begin{list}{}{\cvlist}
\item[{\color{numcolor}\scriptsize6}] \textbf{Arjun Savel}, 2023 (upcoming). "Scientific Writing”, UMD, College Park.\item[{\color{numcolor}\scriptsize5}] \textbf{Arjun Savel}, 2023. "Undergraduate mentoring training”, UMD, College Park.
...
\small
  \begin{list}{}{\cvlist}
  \item[{\color{numcolor}\scriptsize6}]\textbf{Arjun Savel} et al. GMT Community Science Meeting, Washington, D.C. 2023 (upcoming).
...
\resumeItemListStart
\resumeItem{}{UMD Astronomy Graduate School Application Preparation volunteer (2023)}
...
\resumeItemListStart
\resumeItem{}{GMT Community Science Meeting, Washington, D.C. 2023 (upcoming)}
