...
\small
  \begin{list}{}{\cvlist}
    ...
    \item[{\color{numcolor}\scriptsize19}] \textbf{Arjun Savel}, et al., 2025. ``Maximizing constraints from JWST transmission spectra with cross-correlation retrievals''. CHEXO 12, STScI, Baltimore, MD (upcoming)
