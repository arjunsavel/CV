...
%-----------RESEARCH INTERESTS-----------------
\shorterSection{Selected Research Interests}
\resumeItemListStart
\resumeItem{}{Extracting 3-D information (wind, chemical, and thermal structures) from exoplanet atmospheres}
...
\small
  ...
  \item[{\color{numcolor}\scriptsize9}] \textbf{Arjun Savel}, 2022. ``Modeling Lorentz drag in an ultra-hot Jupiter over a range of atmospheric parameters'', Burgers Program Research Symposium on Environmental and Applied Fluid Dynamics, George Washington University. (upcoming)
...
\resumeItemListStart
\resumeItem{}{Panelist: Carnegie EPL Summer Undergraduate Research Internship (SURI) Program’s graduate school workshop (2022, upcoming)}
...
Symposium on Environmental and Applied Fluid Dynamics  (Summer 2022, upcoming)}
\resumeItem{}{Exoplanets IV (Spring 2022)}
