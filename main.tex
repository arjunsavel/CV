...
\cvheading{SKILLS}
\begin{list}{}{\cvlist}
\item \textit{Programming/markup languages}: Python, ADQL/SQL, R, C, HTML, PHP, \LaTeX
\item \textit{Frameworks/tools}: git, SLURM, Numba, SciPy, NumPy, TensorFlow, Pandas
\item \textit{Misc. skills}: MCMC, neural networks, astronomical image reduction, radiative transfer, open-source code management, copy editing
\end{list}
