...
\def\renderunref{%
  ...
  \begin{list}{}{\cvlist}
  \item[{\color{numcolor}\scriptsize2}]\textbf{Savel, Arjun} \etal\, 2022, \emph{Data reduction paper}, submitted
...
\shorterSection{Experience}
  ...
  \resumeSubheading
      ...
      {Data-driven tellurics treatment in high-resolution spectroscopy of exoplanet atmospheres $\vert$ Mentor: Megan Bedell}{2022--current}{
    }
  
    \resumeSubheading
      {Consultant---ScienceBetter Consulting}{New York, NY}
      {Tutorial Jupyter notebooks for MAST science cases $\vert$ Manager: Kelle Cruz}{2022}{
    }
...
\resumeItem{}{Exploring high-resolution spectroscopy and cross-correlation techniques}
...
\begin{list}{}{\cvlist}
\item[{\color{numcolor}\scriptsize4}] \textbf{Arjun Savel}. STAR astronomy club, 2022 (upcoming).
...
\resumeItemListStart
\resumeItem{}{Building Bridges Across Planet-Related Science (2022, upcoming)}
