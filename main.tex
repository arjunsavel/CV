...
\shorterSection{Positions}
  \resumeSubHeadingListStart
      ...
      {Three-dimensionality in high-resolution spectra of hot and ultra-hot Jupiters $\vert$ Advisor: Prof. Eliza M.-R. Kempton}{2020--current}{
    }
...
\small
  ...
  \item[{\color{numcolor}\scriptsize12}] \textbf{Arjun Savel}, 2023 (upcoming). Center for Theory and Computation Lunch Talk, Department of Astronomy, University of Maryland, College Park, MD.

  \item[{\color{numcolor}\scriptsize11}] \textbf{Arjun Savel}, 2023 (upcoming). Flatiron CCA Pre-doctoral Symposium, New York, NY.
...
\small
  \begin{list}{}{\cvlist}
   \item[{\color{numcolor}\scriptsize5}] \textbf{Arjun Savel}, 2023. "Undergraduate mentoring training”, UMD, College Park.
...
\small
  \begin{list}{}{\cvlist}
  \item[{\color{numcolor}\scriptsize5}]\textbf{Arjun Savel} et al. Exoclimes VI, Exeter, UK. 2023 (upcoming).
...
\resumeItemListStart
\resumeItem{}{Exoclimes VI, Exeter, UK (2023, upcoming)}
\resumeItem{}{Flatiron-wide Algorithms and Mathematics, New York (2022)}
\resumeItem{}{Building Bridges Across Planet-Related Science, Baltimore (2022)}
\resumeItem{}{Flatiron Exoplanet Atmospheres Symposium, New York (2022)}
\resumeItem{}{Burgers Program Research
Symposium on Environmental and Applied Fluid Dynamics, Washington, D.C. (2022)}
