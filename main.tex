...
\setcounter{countername}{4} %need a way to set this from number of under review papers!
...
\item[{\color{numcolor}\scriptsize\the\value{countername}}]\textbf{Savel, Arjun} \etal\, 2022, \emph{Data reduction paper}, accepted, PASP
...
\shorterSection{Education}
  \resumeSubHeadingListStart
    ...
    \vspace{-17pt}
    \resumeSubheading
    {}{}{M.S., Astronomy $\vert$ Advisor: Prof. Eliza M.-R. Kempton}{2022, Expected}{
    }
    \vspace{5pt}
    \resumeSubheading
...
\shorterSection{Positions}
  ...
  \resumeSubheading
      {Pre-doctoral fellow---Center for Computational Astrophysics, Flatiron Institute}{New York, NY}
      {Data-driven tellurics treatment in high-resolution spectroscopy of exoplanet atmospheres $\vert$ Mentor: Dr. Megan Bedell}{2022--current}{
    }
  
    \resumeSubheading
      {Consultant---ScienceBetter Consulting}{New York, NY}
      {Tutorial Jupyter notebooks for MAST science cases $\vert$ Manager: Prof. Kelle Cruz}{2022}{
    }
    
     \resumeSubheading
      {Graduate Researcher---University of Maryland, College Park}{College Park, MD}
      {Three-dimensionality in high-resolution transmission spectra of ultra-hot Jupiters $\vert$ Advisor: Prof. Eliza M.-R. Kempton}{2020--current}{
    }
    % \vspace{5pt}
    \resumeSubheading
      {Research Assistant---University of California, Berkeley}{Berkeley, CA}
      {Exoplanet occurrence rates and ground-based imaging follow-up of Kepler stars $\vert$ Advisor: Asst. Prof. Courtney D. Dressing}{2018--2020}{
    }
...
\resumeItem{}{Distinguishing between equilibrium and disequilibrium chemistry in exoplanet atmospheres}
\resumeItem{}{Modeling time-independent magnetohydrodynamics in hot planet atmospheres}
...
\small
  ...
  \item[{\color{numcolor}\scriptsize3}] \textbf{Arjun Savel}, Courtney D. Dressing, Lea Hirsch, David Ciardi, Jordan P.C. Fleming, Jessie L. Christiansen, 2019. “A closer look: AO follow-up of 109 stars in the Kepler and K2 fields”, APSIS Poster Stession, UC Berkeley.
...
\small
  ...
  \item[{\color{numcolor}}]Holden Gill, UC Berkeley (with Asst. Prof. Courtney D. Dressing), 2020--present
...
\resumeItemListStart
\resumeItem{}{Flatiron-wide Algorithms and Mathematics (2022)}
