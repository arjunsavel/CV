...
\def\renderunref{%
  ...
  \begin{list}{}{\cvlist}
\item[{\color{numcolor}\scriptsize3}]\textbf{Savel, Arjun} \etal\, 2022, \emph{Diagnosing limb asymmetries in hot and ultra-hot Jupiters with high-resolution transmission spectroscopy}, submitted
