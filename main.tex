...
%----------HEADING-----------------
\begin{center}
  \small \textbf{\huge Dr. Arjun B. Savel} \\
   \vspace{5pt}
  \small
  \vspace{5pt}
...
\shorterSection{Positions}
  \resumeSubHeadingListStart
      ...
      \resumeSubheading
      {Incoming Postdoctoral Researcher --- Caltech}{Pasadena, CA}
      {Ground-based, high-resolution spectroscopy of exoplanet atmospheres $\vert$ Advisor: Dr. Ray Jayawardhana}{Fall 2026 (upcoming)}{
    }
...
\small
  \begin{list}{}{\cvlist}
  \item[{\color{numcolor}\scriptsize15}] \textbf{Arjun Savel}, Eliza M.-R. Kempton, et al. 3D effects in high-resolution spectroscopy, and the case of TOI-2109b, Granada, Spain, 2026 (upcoming)
...
\resumeItemListStart
\resumeItem{}{\href{https://sites.google.com/view/hors3s/home?authuser=0}{HORS3S}. Granada, Spain (2026, upcoming)}
