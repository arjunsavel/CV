...
\shortershorterSection{\underline{First-author publications}}
% \resumeSubHeadingListStart
\small
\begin{list}{}{\cvlist}
    \input{src/supp_tex/pubs_ref_first_author}
  \end{list}
...
\shortershorterSection{\underline{Other Refereed Contributions}}
% \resumeSubHeadingListStart
\small
\begin{list}{}{\cvlist}
