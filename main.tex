...
\small
  ...
  \item[{\color{numcolor}\scriptsize13}] \textbf{Arjun Savel}, 2024 (upcoming). ``1D on 3D: Simulating the Impact of 3D Atmospheric Structure on 1D High-Resolution Inferences of Transmission Spectra''. UMB's 46th Annual Graduate Research Conference, Baltimore (2024, upcoming)
  
    \item[{\color{numcolor}\scriptsize12}] \textbf{Arjun Savel}, 2024 (upcoming). ``1D on 3D: Simulating the Impact of 3D Atmospheric Structure on 1D High-Resolution Inferences of Transmission Spectra''. UMD's 46th Annual Graduate Research Conference, University of Maryland, College Park (2024, upcoming)
...
\small
  ...
  \item[{\color{numcolor}\scriptsize8}]\textbf{Arjun Savel} et al. Exoplanets V, Leiden, NL. 2024 (upcoming)
...
\small
  ...
  \item[{\color{numcolor}}]\textbf{4.3-meter Lowell Discovery Telescope (EXPRES)} \\
     ...
     Observer. Assisted with 14.5 nights (PI: Dressing)
     \item[{\color{numcolor}}]\textbf{10-meter Keck Telescope (NIRC2)} \\
     Observer. Assisted with 1/2 night (PI: Dressing)
...
\resumeItemListStart
\resumeItem{}{UMB's 46th Annual Graduate Research Conference, Baltimore (2024, upcoming)}
\resumeItem{}{2 Horses, Berlin, DE (2024, upcoming)}
\resumeItem{}{Exoplanets V, Leiden, NL (2024, upcoming)}
