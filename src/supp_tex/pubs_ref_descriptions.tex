...
\ \textbf{Compared spectra to eclipse depths; ran radiative-convective equilibrium models; wrote text; provided substantial comments}
% \ \textbf{\textit{Compared spectra to eclipse depths; ran radiative-convective equilibrium models; wrote text; provided substantial comments}}
...
\ \textbf{Ran grid of disequilibrium chemistry (VULCAN) models; wrote text}

\item[{\color{numcolor}\scriptsize26}] Kempton, Eliza M. -R.; Zhang, Michael; Bean, Jacob L.; Steinrueck, Maria E. \etal\ ({30} other co-authors, incl.\ \textbf{Savel, Arjun}) 2023, \doi{10.1038/s41586-023-06159-5}{A reflective, metal-rich atmosphere for GJ 1214b from its JWST phase curve}, Nature, {620}, 67 (\arxiv{2305.06240}) [\href{https://ui.adsabs.harvard.edu/abs/2023Natur.620...67K}{11 citations}]

\ \textbf{Post-processed GCMs with 3D radiative transfer; wrote text}
...
\ \textbf{Provided ground-based follow-up imaging observations}
...
\ \textbf{Provided insight on 3D models}
...
\ \textbf{Generated opacities; provided plotting scripts; wrote text; provided substantial comments}
...
\item[{\color{numcolor}\scriptsize20}] \textbf{Savel}, \textbf{Arjun}; Kempton, Eliza M. -R.; Rauscher, Emily; Komacek, Thaddeus D. \etal 2023, \doi{10.3847/1538-4357/acb141}{Diagnosing Limb Asymmetries in Hot and Ultrahot Jupiters with High-resolution Transmission Spectroscopy}, \apj, {944}, 99 (\arxiv{2301.01694}) [\href{https://ui.adsabs.harvard.edu/abs/2023ApJ...944...99S}{4 citations}]

\ \textbf{Led paper; performed all simulations; wrote all text}
...
\ \textbf{Led paper; modularized, upgraded, and open-sourced code; wrote all text}
...
\ \textbf{Generated opacities; wrote text; provided substantial comments}
...
\ \textbf{Provided ground-based follow-up imaging observations; wrote text}
...
\ \textbf{Ran periodogram models; provided substantial comments}
...
\ \textbf{Led paper; performed all calculations aside from general circulation models and opacity-generation; wrote all text}
...
\item[{\color{numcolor}\scriptsize6}] May, Erin M.; Komacek, Thaddeus D.; Stevenson, Kevin B.; Kempton, Eliza M. -R. \etal\ ({15} other co-authors, incl.\ \textbf{Savel, Arjun}) 2021, \doi{10.3847/1538-3881/ac0e30}{Spitzer Phase-curve Observations and Circulation Models of the Inflated Ultrahot Jupiter WASP-76b}, \aj, {162}, 158 (\arxiv{2107.03349}) [\href{https://ui.adsabs.harvard.edu/abs/2021AJ....162..158M}{27 citations}]
...
\ \textbf{Added wrapper to numerical relativity code}
