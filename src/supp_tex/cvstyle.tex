...
\geometry{tmargin=1in,bmargin=2.5in,lmargin=0.7in,rmargin=0.7in,includefoot,footskip=25pt}

% Headings and footings.
\renewcommand{\headrulewidth}{0pt}
\pagestyle{fancy}
\lhead{\deemph{Arjun McDanal-Savel}}
\chead{\deemph{Curriculum Vitae\hspace*{-0.3in}}}
\rhead{\deemph{\thepage\hspace*{-0.3in}}}
\cfoot{\deemph{\textit{References available upon request.} \textit{Last updated: \yesterday. CV version tag linked \href{https://github.com/arjunsavel/CV/releases/tag/\today}{here}.}}}
