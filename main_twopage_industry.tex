...
Computational researcher with a PhD background in astronomy, specializing in statistical inference (Python, C, R, \texttt{JAX}, Markov chains), large-scale open-source software, and collaborative knowledge production. Experienced in reproducible research  (CI/CD), community-maintained data, and quantitative evaluation of uncertainty in complex technical workflows.
%-----------EDUCATION-----------------
...
\shorterSection{Positions}
  \resumeSubHeadingListStart
      ...
      {Inferring exoplanet heterogeneity with Bayesian statistics $\vert$ Advisor: Prof. Eliza M.-R. Kempton}{2020--current}{
    }
...
\vspace{-20pt}
  ...
  \resumeSubheading
      ...
      {Developed tutorial Jupyter notebooks for NASA science cases $\vert$ Manager: Prof. Kelle Cruz}{2022--2025}{
    }
\vspace{-20pt}
 \resumeSubheading
      {Freelance Web Developer}{New York, NY}
      {Deployed few-page React websites for academics and small businesses}{2022--2024}{
    }
...
\vspace{-20pt}
      ...
      {Assessed the uncertainty budget of ground-based spectroscopy $\vert$ Advisor: Dr. Megan Bedell}{2022--2023}{
    }
    \vspace{-20pt}
    % \vspace{5pt}
    \resumeSubheading
      {Research Assistant---University of California, Berkeley}{Berkeley, CA}
      {Reliably measured the statistical occurrence of exoplanets $\vert$ Advisor: Prof. Courtney D. Dressing}{2018--2020}{
    }
...
contributions: 4 PI / 1 Co-PI / 8 Co-I on large, internationally distributed collaborations with shared data products, governance structures, and publication norms.
...
\small
  ...
  \item[{\color{numcolor}}]\textbf{James Webb Space Telescope} \\
...
Co-I. \textit{\href{https://www.stsci.edu/jwst/science-execution/program-information?id=8017}{Resolving Atmospheric Uncertainties and Building a Legacy Dataset for WASP-39b} (PI: Welbanks)} \\
  ...
  \item[{\color{numcolor}}]\textbf{8-meter Unit Telescope, Very Large Telescope (ESPRESSO, CRIRES$^+$)} \\
...
\vspace{-2pt}
22 science talks; 5 public talks; 10 misc. technical talks
\vspace{1pt}
