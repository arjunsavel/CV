...
Computational astrophysicist skilled at Python and C optimization (e.g., JAX), working within large codebases, high-performance computing, CI / CD, inference (e.g., Markov chain Monte Carlo, ML).
%-----------EDUCATION-----------------
...
\vspace{-20pt}
  ...
  \resumeSubheading
      ...
      {Tutorial Jupyter notebooks for NASA science cases $\vert$ Manager: Prof. Kelle Cruz}{2022--2025}{
    }
\vspace{-20pt}
 \resumeSubheading
      {Freelance Web Developer}{New York, NY}
      {Tutorial Jupyter notebooks for NASA science cases}{2022--2024}{
    }
