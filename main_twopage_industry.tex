...
Computational astrophysicist skilled at Python and C optimization (e.g., JAX, Numba), working within large codebases, high-performance computing, CI / CD, inference (e.g., Markov chain Monte Carlo, neural inference).
%-----------EDUCATION-----------------
